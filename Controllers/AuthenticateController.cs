...
namespace DotnetStockApi.Controllers
{
    ...
    {
        private readonly ApplicationDbContext _context; //สร้าง Oject ของ ApplicationDbContext
        ...
        IConfiguration configuration )  //ฟังก์ชัน Constructor สำหรับ initial ของค่า ApplicationDbContext
        {
            _context = context;
        ...
        public void TestConnection()
        {
            if(_context.Database.CanConnect())
            {
                ...
                //ถ้าเชื่อมต่อได้จะแสดงข้อความ Not Connected
        ...
        public async Task<ActionResult> RegisterUser([FromBody] RegisterModel model)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(UserRolesModel.User))
            {
                ...
                await _userManager.AddToRoleAsync(user, UserRolesModel.User); //AddToRole
            }
        ...
        private JwtSecurityToken GetToken(List<Claim> authClaims)
        {
            ...
            var token = new JwtSecurityToken(
                ...
                expires: currentTime.AddHours(3), //กำหนดเวลาว่า token จะอยู่นานแค่ไหน
                claims: authClaims,
